...
public:
	...
	static	void	EncodeDataBuffer2(void *_lpBuffer,int _iBufferSize);	//	버퍼
	static	void	DecodeDataBuffer2(void *_lpBuffer,int _iBufferSize);	//	버퍼

	static	void	EncodeBuffer(void *_lpBuffer,int _iBufferSize);	//	버퍼
...
extern	cEncryptGameServerPacketTable	g_gsEncTable;	//	클�E>게임서버�E패킷 인코�E테이�E
