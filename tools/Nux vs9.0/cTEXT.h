...
public:
	...
	static	int			engWidth,hanWidth,spaceWidth,fitSize,fontCount;
	static	HDC			hDC;
	...
	static	int			bufferXSize;
	static	int			bufferYSize;
	static	BYTE		*pBuffer;
...
public:
	...
	static	void		PutOut(int xPos,int yPos,WORD color,char *pStr,int alpha=32);
	static	void		PutOut(int yPos			,WORD color,char *pStr,int alpha=32);
	static	void		FitPut(int xPos,int yPos,WORD color,char *pStr,int alpha=32);
	static	void		PutHanBuffer(int x,int y,BYTE color,BYTE fstByte,BYTE sndByte);
	static	void		PutsBuffer(int xPos,int yPos,BYTE color,char *buffer);

	static	void		PutBuffer(int x,int y,int xs,int ys,BYTE color,BYTE *buffer,char *str);
	static	void		PutBuffer(int x,int y,BYTE color,char *str);
	static	void		PutBuffer(int xs,int ys,BYTE *buffer);
	static	void		PutBuffer(int y,BYTE color,char *fmt);

	static	void		PutDC	 (int xPos,int yPos,int color,char *pStr);		//	Device Cotext拭 啄嬢層陥.
