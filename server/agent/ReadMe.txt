========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Agent
========================================================================


AppWizard has created this Agent application for you.  This application
...
AgentDlg.h, AgentDlg.cpp - the dialog
    ...
    template is in Agent.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CAgentDlgAutoProxy class.  This class
