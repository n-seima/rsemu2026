                                             ...
                                             PEXCEPTION_POINTERS pExceptionInfo )
{
    ...
    if ( m_hReportFile )
    {
        ...
        m_hReportFile = 0;
		MessageBox(NULL,m_szLogFileName,"ERROR",MB_OK);
    }

	MessageBox(NULL,"The Serious Error2","ERROR",MB_OK);

	return EXCEPTION_EXECUTE_HANDLER;	//	깔끔하게 종료해보자..
/*
    if ( m_previousFilter )
