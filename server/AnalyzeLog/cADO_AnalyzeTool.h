#ifndef __CADO_ANALYZETOOL
#define __CADO_ANALYZETOOL
...
using namespace std;
#import "c:\Program Files\Common Files\System\ADO\msado20.tlb" no_namespace rename("EOF", "adoEOF") rename("BOF", "adoBOF")
...
extern cADO_AnalyzeTool	cADO_SERVERINFO;

#endif //	__CADO_ANALYZETOOL