...
// other includes
#include "ftpclass/FTPDataTypes.h"
#include "ftpclass/BlockingSocket.h"
#include "ftpclass/FTPFileState.h"
...
namespace nsFTP
{
   ...
   public:
      ...
      bool UploadFile(const tstring& strLocalFile, const tstring& strRemoteFile, bool fStoreUnique=false, bool fPasv=false,
                      const CRepresentation& repType=CRepresentation(CType::Image())) const;
