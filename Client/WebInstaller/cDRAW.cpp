...
cDRAW::Init()
{
	...
	_WHITE		=RGB555mix(31,63,31);
	_BLACK		=RGB555mix( 0, 0, 0);

	_LTGRAY		=RGB555mix(24,48,24);
	_GRAY 		=RGB555mix(16,32,16);
	_DEEPGRAY	=RGB555mix( 8,16, 8);

	_LTCYAN 	=RGB555mix( 0,63,31);
	_CYAN		=RGB555mix( 0,32,16);
	_DEEPCYAN	=RGB555mix( 0,16, 8);

	_LTBLUE 	=RGB555mix( 0, 0,31);
	_BLUE		=RGB555mix( 0, 0,16);
	_DEEPBLUE	=RGB555mix( 0, 0, 8);

	_LTRED  	=RGB555mix(31, 0, 0);
	_RED	 	=RGB555mix(16, 0, 0);
	_DEEPRED 	=RGB555mix( 8, 0, 0);

	_LTGREEN	=RGB555mix( 0,63, 0);
	_GREEN		=RGB555mix( 0,32, 0);
	_DEEPGREEN	=RGB555mix( 0,16, 0);

	_LTYELLOW	=RGB555mix(31,63, 0);
	_YELLOW		=RGB555mix(16,32, 0);
	_DEEPYELLOW	=RGB555mix( 8,16, 0);

	_LTPURPLE	=RGB555mix(31, 0,31);
	_PURPLE		=RGB555mix(16, 0,16);
	_DEEPPURPLE	=RGB555mix( 8, 0, 8);
