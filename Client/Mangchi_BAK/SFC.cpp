...
GetMoneyString(LONGLONG _llMoney)
{
	...
	if	(iUk && iMan && iGold)
	{
		sprintf(s_strGold,"%d%s %d%s %d",iUk,"억",iMan,"만",iGold);
	}
	else
	if	(iUk && iMan)
	{
		sprintf(s_strGold,"%d%s %d%s",iUk,"억",iMan,"만");
	}
	else
	if	(iUk && iGold)
	{
		sprintf(s_strGold,"%d%s %d",iUk,"억",iGold);
	}
	else
	if	(iUk)
	{
		sprintf(s_strGold,"%d%s",iUk,"억");
	}
	else
	if	(iMan && iGold)
	{
		sprintf(s_strGold,"%d%s %d",iMan,"만",iGold);
	}
	else
	if	(iMan)
	{
		sprintf(s_strGold,"%d%s",iMan,"만");
	}
	else
	{
