...
///////////////////////////////////////////////////////////////////////////
	...
	cTEXT::cPut(x+iWidth/2,y+5,SKYBLUE,_ms("발동 확률 [%d％] 체크 주기 [%d초] 발동 횟수 제한 [%d회] 활성 트리거 주건수 [%d회]",karma.m_wActivateChance,karma.m_wActivePeriod,karma.m_wActiveCount,karma.m_bf7ActivateTriggerCount));
	y	+=	18;
