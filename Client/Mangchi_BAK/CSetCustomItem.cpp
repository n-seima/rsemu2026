...
//--------------------------------------------------------------------	등록된 접두사 윈도우 초기화
	{
		...
		s_listRegistPrefix.AddColumn("1차 접두사"	,6*12);
		s_listRegistPrefix.AddColumn("접두사 타입"	,6*20);
		s_listRegistPrefix.AddColumn("질"			,6*5);
		s_listRegistPrefix.AddColumn("수치1"		,6*7);
		s_listRegistPrefix.AddColumn("수치2"		,6*7);
