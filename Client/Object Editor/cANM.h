...
public:
	...
	WORD			FrameCount,directCount;							//	프레임 카운트와 에니메이션 카운트
	BYTE			bSTATIC,ALPHA;
	...
	static	WORD	PLT[256];
	static	int		BPP,AnmType,AnmCount,CurAnm,CurFrame,CurDirect,CrashType,s_iFPS;
