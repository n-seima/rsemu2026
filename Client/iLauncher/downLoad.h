...
public:	
	...
	__int64			m_dwCurrentFileSize,m_dwCurrentFileReceivedSize,m_dwBeginTime,m_dwBps,m_dwProgressTime;
	__int64			m_dwReceivedSize;
	int				m_iProgressRate;
	BOOL			m_bIsCancelWork,m_bIsPauseWork,m_bIsComplete,m_bIsExtractFile;
	...
	void			reset();
	void			setBeginTime();
	BOOL			downLoad(char *strUrl,void	(*update)(cDOWNLOAD*),int _iDownLoadOption=URLOSTRM_GETNEWESTVERSION);
