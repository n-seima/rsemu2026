...
//	초기화
	...
	strcpy(l_infoNux.m_strDestFolder,destFolder);
...
//	outFile	=	NULL;
	...
	{	int read	=	read_header();
		...
		if (read == 2)
		{
			...
			sprintf(l_infoNux.m_strDestFolder,"%s\\%s",destFolder,folderName);
		...
		strcpy(l_infoNux.m_strCurrentFile,filename);
...
//	초기화
	...
	{	DWORD	size;
		...
		strcpy(l_infoNux.m_strCurrentFile,CurrentFile);
