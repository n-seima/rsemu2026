...
///////////////////////////////////////////////////////////////////////////
	...
	cTEXT::cPut(x+iWidth/2,y+5,SKYBLUE,_ms("Activation probability [%d%] Check period [%d seconds] Activation count limit [%d times] Number of active triggers [%d times ]",karma.m_wActivateChance,karma.m_wActivePeriod,karma.m_wActiveCount,karma.m_bf7ActivateTriggerCount));
	...
	cTEXT::cPut(x + iWidth / 2, y, LTCYAN, "Operations to perform");
