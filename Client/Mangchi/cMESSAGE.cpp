...
"Weapon Point",
"Defense Equipment Store",
"variety store",
"Accessory Store",
"Street stalls (use general stores instead)",
"bank",
"Skill Master",
...
"blacksmith",
"First Helper",
"Holding Quest Client",
"Show people involved in held quests",
"An opponent that must be eliminated",
"Apprentice Knight/Warrior Arms Dealer",
"Wizard/Werewolf Arms Dealer",
"Priest/Fallen Angel Weapon Dealer",
"Thief/Martial Arts Arms Dealer",
"Magic Spear Swordsman/Magic Archer Weapon Dealer",
"Trainer/Summoner Weapon Dealer",
"Princess/Transforming Girl Weapon Dealer",
"Spiritualist/Demon Arms Dealer",
"Dueling Ground Reward",
"Psychic/Martial Arts Weapon Dealer",
"Guildhall Teleporter",
"Event Assistant",
"Adventurer Association",
"Optics Master/Beast Weapon Dealer",
	"end"
};	//	char *g_strNpcCategorty[]
