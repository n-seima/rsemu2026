...
cSetMainQuest::AddChapter(HWND hDlg)
{
	...
	{
		cMSG::Error("error!","No more chapters can be added.");
		return;
	}
...
cSetMainQuest::ModifyChapterName(HWND hDlg)
{
	...
	{
		cMSG::Error("error!","No chapters have been selected. Please select a chapter first.");
		return;
	}
...
cSetMainQuest::AddHighQuest(HWND hDlg)
{
	...
	if	(!lpChapter)
	{
		cMSG::Error("error!","Please select a chapter first.");
		return;
	}

	if	(!lpChapter->addHighQuest(strHighQuestName))
	{
		cMSG::Error("error!","No more tier quests can be added to the current chapter.");
		return;
	}
...
cSetMainQuest::ModifyHighQuestName(HWND hDlg)
{
	...
	{
		cMSG::Error("error!","Please select a higher level quest first.");
		return;
	}
...
cSetMainQuest::RemoveHighQuest(HWND hDlg)
{
	...
	{
		cMSG::Error("error!","Please select a chapter and upper level quest first.");
		return;
	}
