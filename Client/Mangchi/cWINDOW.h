...
public:
	...
	HTREEITEM	Add(char *text,int _iData=-1);
	HTREEITEM	Add(HTREEITEM hParent,char *text,int _iData=-1);
...
public:
	...
	static	int		GetIndexByText(HWND hwnd, char* pText);			// 09.08.07
...
public:
	...
	BOOL		VScroll(WORD wScroll, int _linestep = 1);			// 09.12.17 수정
