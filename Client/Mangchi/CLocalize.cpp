...
cMAIN::s_procSelectTargetLanguage(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch(uMsg)
	{
		case WM_INITDIALOG	:
		{
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "Japanese", eNationJapan);
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "Chinese", eNationChina);
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "Korean", eNationKorea);
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "International", eNationInter);
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "United States", eNationUsa);
			cLISTBOX::Add(GetDlgItem(hwnd, IDC_LIST), "Thai", eNationThai);
			break;
		}
