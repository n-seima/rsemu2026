...
{
	{eABP_LEVEL				,dPOWER_VALUE		,"level"				,1	,1000			},
	{eABP_STRENGTH			,dPOWER_VALUE		,"strength"				,5	,1000			},
	{eABP_DEXTERITY			,dPOWER_VALUE		,"agility"			,5	,1000			},
	{eABP_CONSTITUTION		,dPOWER_VALUE		,"health"				,5	,1000			},
	{eABP_WISDOM			,dPOWER_VALUE		,"wisdom"				,5	,1000			},
	{eABP_INTELLIGENCE		,dPOWER_VALUE		,"knowledge"				,5	,1000			},
	{eABP_CHARISMA			,dPOWER_VALUE		,"charisma"			,5	,1000			},
	{eABP_LUCK				,dPOWER_VALUE		,"Luck"				,5	,1000			},

	{eABP_ATTACK			,dPOWER_VALUE		,"Attack"			,1	,65535			},
	{eABP_DEFENSE			,dPOWER_VALUE		,"defense"			,1	,65535			},
	{eABP_FIRE_RESIST		,dPOWER_PERCENTAGE	,"fire resistance"			,0	,100			},
	{eABP_WATER_RESIST		,dPOWER_PERCENTAGE	,"water resistance"			,0	,100			},
	{eABP_WIND_RESIST		,dPOWER_PERCENTAGE	,"wind resistance"		,0	,100			},
	{eABP_EARTH_RESIST		,dPOWER_PERCENTAGE	,"Earth Resistance"		,0	,100			},
	{eABP_LIGHT_RESIST		,dPOWER_PERCENTAGE	,"Light Resistance"			,0	,100			},
	{eABP_DARK_RESIST		,dPOWER_PERCENTAGE	,"Darkness Resistance"		,0	,100			},
	{eABP_MAGIC_RESIST		,dPOWER_PERCENTAGE	,"magic resistance"		,0	,100			},
	{0xffff},
};

cPOWER_INFO	g_aLimitedPowers[50]	=
{
	{eABP_LEVEL						,dPOWER_VALUE		,"level"				,10	,10000			},
	{eABP_STRENGTH					,dPOWER_VALUE		,"strength"		,1	,5000			},
	{0xffff},
};
...
cACTOR_SET::drawMonsterAreaInfo(int _index, cRECT *_rect)
{
	...
	// 09.12.18
	cTEXT::Put(x, y, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("area size : %d x %d", (_rect->x2 - _rect->x1), (_rect->y2 - _rect->y1)));
	...
	if( cnt != 0)
	{
		...
		cTEXT::Put(x, y + 13 * 2, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Defense: %s", GetCommaIndex(iAllDEF / cnt)));
		cTEXT::Put(x, y + 13 * 3, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Skill Attack: %s", GetCommaIndex(iAllSkillDamage / cnt)));
		cTEXT::Put(x, y + 13 * 4, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Regen cycle: %d hours %02d minutes %02d seconds", iAllRegenCycle / 60 / 60, (iAllRegenCycle / 60) % 60, iAllRegenCycle % 60));
		cTEXT::Put(x, y + 13 * 5, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Total experience: %s", GetCommaIndex(itotExp)));
		cTEXT::Put(x, y + 13 * 7, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Fire : %d %%", iAllFire / cnt));
		cTEXT::Put(x, y + 13 * 8, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Water : %d %%", iAllWater / cnt));
		cTEXT::Put(x, y + 13 * 9, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Wind: %d %%", iAllWind / cnt));
		cTEXT::Put(x, y + 13 * 10, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Light : %d %%", iAllLight / cnt));
		cTEXT::Put(x, y + 13 * 11, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Earth: %d %%", iAllEarth / cnt));
		cTEXT::Put(x, y + 13 * 12, cSET_FONT::s_OldColorOption[eCOLOR_MONSTER_INFO], _ms("Dark : %d %%", iAllDark / cnt));
