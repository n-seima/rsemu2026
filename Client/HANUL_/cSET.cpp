...
char		*strAnmDirect[]	=	{"방향 없음","좌우 2 방향","상하 2 방향","4 방향","8 방향","16 방향","32 방향","64 방향"};
...
//	crashType	=	cANM::CrashType;
	...
	//	전체 설정..
	for (i=0;i<8;i++)	cCOMBOBOX::Add(GetDlgItem(hDlg,IDC_ANI_KIND),_ms("%s 에니메이션",strAnmType[i]));
...
cSET::InsertAnm(HWND _hDlg)
{
	...
	strcpy(tempAnm[curAnm].Name,"_끼어넣기");
